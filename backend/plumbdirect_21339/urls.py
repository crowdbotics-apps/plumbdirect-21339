"""plumbdirect_21339 URL Configuration
...
admin.site.site_header = "PlumbDirect"
admin.site.site_title = "PlumbDirect Admin Portal"
admin.site.index_title = "PlumbDirect Admin"

# swagger
api_info = openapi.Info(
    title="PlumbDirect API",
    default_version="v1",
    description="API documentation for PlumbDirect App",
)
